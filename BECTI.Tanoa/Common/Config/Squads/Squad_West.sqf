...
missionNamespace setVariable [format["CTI_SQUADS_%1_CATEGORY_AIR", _side], [["HeliAttack", 1],["AirAttack", 1, 85]]];
...
_v = _v		+ ["AirAttack"];
_t = _t		+ ["Heli - Airborne"];
_p = _p		+ [[["us_rg_uh60m", 1], ["us_dvg_operator_m4", 3], ["us_dvg_operator_mk16", 2], ["us_dvg_operator_mk17", 2]]];
_f = _f		+ [CTI_AIR];
_m = _m		+ [20000];
_c = _c		+ ["Air"];
_s = _s		+ [[]];
