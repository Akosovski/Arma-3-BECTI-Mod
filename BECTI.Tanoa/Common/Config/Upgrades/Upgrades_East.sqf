...
missionNamespace setVariable [Format["CTI_%1_UPGRADES_COSTS", _side], [
	...
	[[3500,5000],[6500,12000]], //--- Air
	[[15000,25000]], //--- Satellite
	[[1500,5000]], //--- Air FFAR
	[[5000,20000]], //--- Air AT
	[[7500,30000]], //--- Air AA
	[[4500,14000]], //--- Air CM
	[[2000,2500], [4000,8000], [9000,10000]], //--- Towns Occupation
...
if (CTI_IsClient) then {
	missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
		["Barracks", "Provides reinforcement of VMF Infantry units.<br />Level 1: VMF Basic Infantry<br />Level 2: VMF Upgraded Infantry<br />Level 3: GRU Spetsnaz Operators"], //--- Barracks
		["Light Factory", "Provides reinforcement of VMF Light Vehicles.<br />Level 1: VMF Motorized APC<br />Level 2: VMF Mechanized IFV<br />Level 3: VMF Upgraded Mechanized IFV"], //--- Light
		["Heavy Factory", "Provides reinforcement of VMF Tanks and Artillery.<br />Level 1: VMF Basic Tanks<br />Level 2: VMF Upgraded Tanks"], //--- Heavy
		["Aircraft Factory", "Provides reinforcement of VMF Helicopters and Planes.<br />Level 1: VMF Basic Helicopters<br />Level 2: VMF Attack Helicopters and Planes<br />Level 3: VMF Upgraded Planes"], //--- Air
