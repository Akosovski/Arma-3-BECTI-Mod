...
_i = _i		+ ["JCA_arifle_M4A1_GL_sand_F"];
_u = _u		+ [1];
_p = _p		+ [35];
...
_i = _i		+ ["JCA_arifle_M4A1_short_sand_F"];
_u = _u		+ [1];
_p = _p		+ [35];
...
_i = _i		+ ["CUP_lmg_Mk48_od"];
_u = _u		+ [2];
_p = _p		+ [55];

_i = _i		+ ["CUP_lmg_Mk48_nohg"];
_u = _u		+ [3];
_p = _p		+ [55];

_i = _i		+ ["CUP_lmg_Mk48_nohg_od"];
_u = _u		+ [3];
_p = _p		+ [55];
...
_i = _i + ["V_CarrierRigKBT_01_Heavy_Olive_F"];
_u = _u + [3];
_p = _p + [25];
