...
missionNamespace setVariable [format["CTI_%1_HQ", _side], "rhsusf_M1083A1P2_B_M2_d_MHQ_fmtv_usarmy"];
...
_classes pushBack ["Land_i_House_Small_03_V1_F", "Land_House_Small_03_V1_ruins_F", ["Land_i_House_Small_03_V1_dam_F"]];
