...
switch (true) do {
	case ( _maxSV <= 30) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_VEHICLE_MOTORIZED", 1]];
	};
	case (_maxSV > 30 && _maxSV <= 40) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIER_MG", 2], ["GUER_SOLDIER_AR", 2], ["GUER_SOLDIERS_MARKSMEN", 1], ["GUER_VEHICLES_LIGHT", 2]];
	};
	case (_maxSV > 40 && _maxSV <= 50) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 2], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 2], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_MARKSMEN", 1], ["GUER_VEHICLES_LIGHT", 2], ["GUER_VEHICLES_MEDIUM", 1]];
	};
	case (_maxSV > 50 && _maxSV <= 60) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_SOLDIERS_MARKSMEN", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 1]];
	};
	case (_maxSV > 60 && _maxSV <= 70) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIERS_AT_HEAVY", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_MARKSMEN", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 1]];
	};
	case (_maxSV > 70 && _maxSV <= 80) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIERS_AT_HEAVY", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_MARKSMEN", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 1]];
	};
	case (_maxSV > 80 && _maxSV <= 90) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIERS_AT_HEAVY", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 1], ["GUER_VEHICLES_HEAVY", 1]];
	};
	case (_maxSV > 90 && _maxSV <= 100) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIERS_AT_HEAVY", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 1], ["GUER_VEHICLES_HEAVY", 1]];
	};
	case (_maxSV > 100 && _maxSV <= 110) : { 
		_pool_units = [["GUER_SOLDIER", 3], ["GUER_SOLDIER_GL", 1], ["GUER_SOLDIERS_AT_LIGHT", 2], ["GUER_SOLDIERS_AT_HEAVY", 2], ["GUER_SOLDIER_AA", 1], ["GUER_SOLDIER_MEDIC", 1], ["GUER_SOLDIERS_MG", 2], ["GUER_SOLDIERS_ENGINEER", 1], ["GUER_SOLDIERS_SPECOPS", 1], ["GUER_SOLDIERS_SNIPERS", 1], ["GUER_VEHICLES_LIGHT", 1], ["GUER_VEHICLES_MEDIUM", 2], ["GUER_VEHICLES_HEAVY", 1]];
	};
