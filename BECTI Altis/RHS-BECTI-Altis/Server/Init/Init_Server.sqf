...

{
	...
	switch (typeOf _hq) do
	{
		case "rhsusf_M1083A1P2_B_M2_d_MHQ_fmtv_usarmy" : { [_hq,1,true] spawn rhs_fnc_fmtv_Deploy };
		case "rhs_gaz66_r142_msv" : {  [_hq,1,true] spawn rhs_fnc_gaz66_radioDeploy };
		case default {};
	};
