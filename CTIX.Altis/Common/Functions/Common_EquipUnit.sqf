...
if ((_new select 2) select 0 != backpack _unit || not(((_new select 2) select 1) isEqualTo (backpackItems _unit))) then {
	[_unit, (_new select 2) select 0, (_new select 2) select 1] call CTI_CO_FNC_EquipContainerBackpack;
};
if ((_new select 1) select 0 != vest _unit || not(((_new select 1) select 1) isEqualTo (vestItems _unit))) then {
	[_unit, (_new select 1) select 0, (_new select 1) select 1] call CTI_CO_FNC_EquipContainerVest;
};
if ((_new select 0) select 0 != uniform _unit || not(((_new select 0) select 1) isEqualTo (uniformItems _unit))) then {
	[_unit, (_new select 0) select 0, (_new select 0) select 1] call CTI_CO_FNC_EquipContainerUniform;
};
