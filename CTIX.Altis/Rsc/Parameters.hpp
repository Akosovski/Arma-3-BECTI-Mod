class Params {
	...
	class CTI_ECONOMY_INCOME_CYCLE {
		...
		texts[] = {"30 Seconds","1 Minute","1,5 Minutes","2 Minutes","2,5 Minutes","3 Minutes"};
		default = 30;
	};
	class CTI_ECONOMY_STARTUP_FUNDS_EAST_COMMANDER {
		...
		texts[] = {"$35000","$15000","$20000","$25000","$30000","$35000","$40000","$45000","$50000","$100000"};
		default = 35000;
	};
	...
	class CTI_RESPAWN_TIMER {
		title = "RESPAWN: Delay";
		values[] = {8,15,20,25,30,35,40,45,50,55,60};
		texts[] = {"8 Seconds","15 Seconds","20 Seconds","25 Seconds","30 Seconds","35 Seconds","40 Seconds","45 Seconds","50 Seconds","55 Seconds","60 Seconds"};
		default = 8;
	};
