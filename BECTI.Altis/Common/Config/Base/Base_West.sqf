...
missionNamespace setVariable [format["CTI_%1_HQ", _side], "us_rg_uh60m"];
...
_helper = _helper			+ [[""]];
_specials = _specials		+ [[["DMG_Reduce", 3]]];
...
_classes = _classes 		+ [["Land_Cargo_Patrol_V3_F", "Land_Cargo_Patrol_V3_ruins_F"]];
_prices = _prices 			+ [600];
_times = _times 			+ [30];
...
_headers = _headers 		+ ["Helipad (Square)"];
