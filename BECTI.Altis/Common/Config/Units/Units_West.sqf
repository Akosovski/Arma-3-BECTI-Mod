...
_c = _c + ['us_rg_commander'];
_p = _p + ['rhsusf\addons\rhsusf_main\data\armylogo.paa'];
_n = _n + ['US Rangers Commander'];
_o = _o + [200];
_t = _t + [3];
_u = _u + [1];
_f = _f + [CTI_FACTORY_BARRACKS];
...
_c = _c + ['us_dvg_operator_m249'];
_p = _p + ['rhsusf\addons\rhsusf_main\data\navylogo.paa'];;
_n = _n + ['DEVGRU Operator (M249)'];
_o = _o + [340];
_t = _t + [3];
_u = _u + [3];
_f = _f + [CTI_FACTORY_BARRACKS];
...
_c = _c + ['us_dvg_operator_sr10'];
_p = _p + ['rhsusf\addons\rhsusf_main\data\navylogo.paa'];;
_n = _n + ['DEVGRU Operator (SR10)'];
_o = _o + [350];
_t = _t + [3];
_u = _u + [3];
_f = _f + [CTI_FACTORY_BARRACKS];
...
_c = _c + ['us_usmc_commander'];
_p = _p + ['rhsusf\addons\rhsusf_main\data\usmclogo.paa'];
_n = _n + ['USMC Commander'];
_o = _o + [200];
_t = _t + [3];
_u = _u + [0];
_f = _f + [CTI_FACTORY_BARRACKS];
