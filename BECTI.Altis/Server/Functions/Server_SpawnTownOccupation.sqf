...
switch (true) do {
	...
	case (_SV > 15 && _SV <= 25) : { 
		_pool_units = [["MARINE", 4], ["MARINE_GL", 3], ["MARINES_AT_LIGHT", 2], ["MARINE_AA", 1, 60], ["MARINE_MEDIC", 2], ["MARINES_MG_LIGHT", 2], ["MARINE_AR", 2], ["MARINES_ENGINEER", 1], ["MARINES_MARKSMEN", 1, 75], ["VEHICLES_LIGHT", 2, 70], ["VEHICLE_APC", 1, 70]];
	};
	case (_SV > 25 && _SV <= 40) : { 
		_pool_units = [["MARINE", 4], ["MARINE_GL", 2], ["MARINES_AT_LIGHT", 2], ["MARINE_AA", 1, 70], ["MARINE_MEDIC", 2], ["MARINES_MG_LIGHT", 2], ["MARINES_ENGINEER", 1], ["MARINES_MARKSMEN", 1, 70], ["VEHICLES_LIGHT", 1, 80], ["VEHICLES_MEDIUM", 1, 80], ["VEHICLES_AA_LIGHT", 1, 60]];
	};
	case (_SV > 40 && _SV <= 60) : { 
	...
	case (_SV > 60 && _SV <= 70) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIERS_AT_MEDIUM", 2], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1, 90], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["OLDIERS_MARKSMEN", 1, 80], ["VEHICLES_LIGHT", 1, 70], ["VEHICLES_MEDIUM", 1, 60], ["VEHICLES_HEAVY", 1, 75], ["VEHICLES_AA_LIGHT", 1, 60]];
	};
	case (_SV > 70 && _SV <= 80) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIERS_AT_MEDIUM", 2], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1, 90], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_MARKSMEN", 1, 80], ["VEHICLES_LIGHT", 1, 70], ["VEHICLES_MEDIUM", 1, 80], ["VEHICLES_HEAVY", 1, 75], ["VEHICLES_AA_LIGHT", 1, 60]];
	};
	case (_SV >= 80) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIERS_AT_MEDIUM", 2], ["SOLDIERS_AT_HEAVY", 2, 70], ["SOLDIER_AA", 1, 90], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1], ["VEHICLES_LIGHT", 1, 60], ["VEHICLES_MEDIUM", 1], ["VEHICLES_HEAVY", 1, 75], ["VEHICLES_AA_LIGHT", 1, 75]];
	};
};
