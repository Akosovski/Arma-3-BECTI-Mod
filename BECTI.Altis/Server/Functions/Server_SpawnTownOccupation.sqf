...
switch (true) do {
	...
	case (_SV > 10 && _SV <= 20) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIER_AA", 1, 60], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_LIGHT", 2], ["SOLDIER_AR", 2], ["SOLDIERS_ENGINEER", 1, 75], ["WEST_SOLDIERS_MARKSMEN", 1, 75], ["VEHICLES_LIGHT", 2, 50], ["VEHICLE_APC", 1, 50]];
	};
	case (_SV > 20 && _SV <= 40) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 2], ["SOLDIERS_AT_LIGHT", 2], ["SOLDIER_AA", 1, 70], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_LIGHT", 2], ["SOLDIERS_ENGINEER", 1, 70], ["WEST_SOLDIERS_MARKSMEN", 1, 70], ["VEHICLES_LIGHT", 2, 80], ["VEHICLES_MEDIUM", 1, 40], ["VEHICLES_AA_LIGHT", 1, 50]];
	};
	case (_SV > 40 && _SV <= 60) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 90], ["SOLDIERS_AT_MEDIUM", 2, 60], ["SOLDIER_AA", 1, 60], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_LIGHT", 2], ["SOLDIERS_ENGINEER", 1, 80], ["SOLDIERS_SPECOPS", 1], ["WEST_SOLDIERS_MARKSMEN", 1, 75], ["VEHICLES_LIGHT", 1, 60], ["VEHICLES_MEDIUM", 1, 70], ["VEHICLES_AA_LIGHT", 1, 30]];
	};
	case (_SV > 60 && _SV <= 70) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 80], ["SOLDIERS_AT_MEDIUM", 2, 60], ["SOLDIERS_AT_HEAVY", 2, 60], ["SOLDIER_AA", 1, 60], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["WEST_SOLDIERS_MARKSMEN", 1, 80], ["VEHICLES_LIGHT", 1, 80], ["VEHICLES_MEDIUM", 1, 60], ["VEHICLES_HEAVY", 1, 60], ["VEHICLES_AA_LIGHT", 1, 40]];
	};
	case (_SV > 70 && _SV <= 80) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 70], ["SOLDIERS_AT_MEDIUM", 2, 60], ["SOLDIERS_AT_HEAVY", 2, 50], ["SOLDIER_AA", 1, 60], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["WEST_SOLDIERS_MARKSMEN", 1, 85], ["VEHICLES_LIGHT", 1, 60], ["VEHICLES_MEDIUM", 1, 80], ["VEHICLES_HEAVY", 1, 60], ["VEHICLES_AA_LIGHT", 1, 60]];
	};
	case (_SV >= 80) : { 
		_pool_units = [["SOLDIER", 3], ["SOLDIER_GL", 1], ["SOLDIERS_AT_LIGHT", 2, 80], ["SOLDIERS_AT_MEDIUM", 2, 80], ["SOLDIERS_AT_HEAVY", 2, 60], ["SOLDIER_AA", 1, 70], ["SOLDIER_MEDIC", 2], ["SOLDIERS_MG_MEDIUM", 1], ["SOLDIERS_ENGINEER", 1, 75], ["SOLDIERS_SPECOPS", 1], ["SOLDIERS_SNIPERS", 1, 90], ["VEHICLES_LIGHT", 1, 40], ["VEHICLES_MEDIUM", 1], ["VEHICLES_HEAVY", 1, 60], ["VEHICLES_AA_LIGHT", 1, 50]];
	};
};
