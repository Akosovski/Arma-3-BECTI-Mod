class Params {
	...
	class CTI_BASE_STARTUP_PLACEMENT {
		...
		values[] = {1000,2000,4000,6000,15000};
		texts[] = {"1KM","2 KM","4 KM","6 KM","15 KM"};
		default = 15000;
	};
	...
	class CTI_ECONOMY_INCOME_CYCLE {
		title = "INCOME: Delay";
		values[] = {45,75,90,120,160,190};
		texts[] = {"45 Seconds","01:15 Minute","01:30 Minutes","02:00 Minutes","02:30 Minutes","03:00 Minutes"};
		default = 45;
	};
	...
	class CTI_ECONOMY_STARTUP_FUNDS_EAST_COMMANDER {
		...
		values[] = {9000,15000,20000,25000,30000,35000,40000,45000,50000,60000,100000};
		texts[] = {"$9000","$15000","$20000","$25000","$30000","$35000","$40000","$45000","$50000","$60000","$100000"};
		default = 100000;
	};
	class CTI_ECONOMY_STARTUP_FUNDS_EAST {
		title = "INCOME: Starting Funds (East Players)";
		values[] = {900,1500,2400,3200,6000,8000,10000,12500,15000,20000,95000};
		texts[] = {"$900","$1500","$2400","$3200","$6000","$8000","$10000","$12500","$15000","$20000","$95000"};
		default = 95000;
	};
	class CTI_ECONOMY_STARTUP_SUPPLY_EAST {
		title = "INCOME: Starting Supply (East)";
		values[] = {1200,2400,3600,4800,6000,7200,8400,10000,50000};
		texts[] = {"S1200","S2400","S3600","S4800","S6000","S7200","S8400","S10000","S50000"};
		default = 50000;
	};
