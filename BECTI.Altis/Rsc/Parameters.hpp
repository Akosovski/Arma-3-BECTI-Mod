class Params {
	...
	class CTI_ECONOMY_STARTUP_FUNDS_EAST {
		...
		values[] = {900,1500,2400,3200,6000,8000,10000,12500,15000,20000,55000};
		texts[] = {"$900","$1500","$2400","$3200","$6000","$8000","$10000","$12500","$15000","$20000","$55000"};
		default = 55000;
	};
	class CTI_ECONOMY_STARTUP_SUPPLY_EAST {
		title = "INCOME: Starting Supply (East)";
		values[] = {1200,2400,3600,4800,6000,7200,8400,10000,45000};
		texts[] = {"S1200","S2400","S3600","S4800","S6000","S7200","S8400","S10000","S45000"};
		default = 45000;
	};
