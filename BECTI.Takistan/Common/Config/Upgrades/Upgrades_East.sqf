...
if (CTI_IsClient) then {
	missionNamespace setVariable [Format["CTI_%1_UPGRADES_LABELS", _side], [
		["Barracks", "Provides reinforcement of MSV Infantry units.<br />Level 1: VDV Basic Infantry<br />Level 2: VDV Upgraded Infantry<br />Level 3: GRU Spetsnaz Operators"], //--- Barracks
